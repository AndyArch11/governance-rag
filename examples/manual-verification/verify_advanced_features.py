...
Run it directly from project root:
    python3 examples/manual-verification/verify_advanced_features.py
"""

import sys
from pathlib import Path

# Add project root to path (examples/manual-verification/ → project root)
...
def main():
    print("=" * 60)
    print("Advanced Features Verification (Manual)")
    print("=" * 60)
