...
class TestResourceMetrics:
    ...
    def test_resource_metrics_initialisation(self):
        ...
        metric = ResourceMetrics(
            cpu_percent=50.5, memory_percent=25.3, memory_mb=1024.5, thread_count=8
        )
...
class TestConcurrentFileProcessor:
    ...
    def test_process_files_with_single_file(self, mock_collections, mock_parser, mock_config):
        ...
        with (
            patch("scripts.ingest.ingest_git.process_code_file") as mock_process,
    ...
    def test_process_files_starts_resource_monitor(
        self, mock_collections, mock_parser, mock_config
    ):
    ...
    def test_processor_uses_configured_max_workers(
        self, mock_collections, mock_parser, mock_config
    ):
