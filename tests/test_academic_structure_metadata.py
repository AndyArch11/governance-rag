...
Aarons, G. A., Ehrhart, M. G., Torres, E. M., et al. (2017)..."""
        ...
        assert 'Chapter 1' in intro_mapping['chapter'] or 'Introduction' in str(intro_mapping['chapter'])
        ...
        assert 'Chapter 3' in methods_mapping['chapter'] or 'Methodology' in str(methods_mapping.get('heading_path', ''))
