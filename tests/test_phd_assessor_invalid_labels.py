    ...
    def test_sections_with_same_sequence_preserve_insertion_order(self, assessor):
        ...
        chunks_data = {
            ...
            "metadatas": [
                ...
                {"chunk_type": "parent", "chapter": "Acknowledgements", "sequence_number": float('inf')},
                {"chunk_type": "parent", "chapter": "Introduction", "sequence_number": float('inf')},
        ...
        expected_order = ["Abstract", "Acknowledgements", "Introduction", "Conclusion", "References"]
        assert chapter_names == expected_order, \
    ...
    def test_mixed_sequence_numbers_with_stable_secondary_sort(self, assessor):
        ...
        chunks_data = {
            ...
            "metadatas": [
                ...
                {"chunk_type": "parent", "chapter": "Chapter 1", "sequence_number": 100},
                {"chunk_type": "parent", "chapter": "Chapter 2", "sequence_number": 200},
                {"chunk_type": "parent", "chapter": "Acknowledgements", "sequence_number": 10},  # Same as Abstract
                {"chunk_type": "parent", "chapter": "Chapter 3", "sequence_number": 300},
        ...
        assert abstract_idx < chapter1_idx, "Abstract (seq 10) should come before Chapter 1 (seq 100)"
    ...
    def test_chapter_ordering_with_gap(self, assessor):
        ...
        chunks_data = {
            ...
            "metadatas": [
                ...
                {"chunk_type": "parent", "chapter": "Chapter 6", "sequence_number": 600},  # Correct seq
