...
class TestORCIDProvider:
    ...
    def test_extract_orcid_id(self):
        ...
        # URL format
        assert provider._extract_orcid_id("https://orcid.org/0000-0002-1825-0097") == "0000-0002-1825-0097"
...
class TestGoogleScholarProvider:
    ...
    @patch('scripts.ingest.academic.providers.google_scholar.GoogleScholarProvider._request_with_retry')
    @patch('scripts.ingest.academic.providers.google_scholar.GoogleScholarProvider._enforce_extra_delay')
...
class TestURLFetchProvider:
    ...
    def test_extract_url(self):
        ...
        # Simple URL
        assert provider._extract_url("https://example.com/paper.pdf") == "https://example.com/paper.pdf"
