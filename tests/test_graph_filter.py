...
def sample_graph_data():
    ...
    return {
        ...
        "edges": [
            {
                "source": "Handler.java_v1",
                "target": "service/Controller.groovy_v1",
                "weight": 0.8,
                "relationship_type": "conflict",
            },
            {
                "source": "Handler.java_v1",
                "target": "utils/helper.py_v2",
                "weight": 0.5,
                "relationship_type": "duplicate",
            },
            {
                "source": "service/Controller.groovy_v1",
                "target": "docs/API.md_v1",
                "weight": 0.3,
...
class TestBuildSqlWhereClause:
    ...
    def test_build_where_clause_parametrised_safe(self, sample_graph_data):
        ...
        # Try to inject SQL
        where_clause, params = gf.build_sql_where_clause(doc_types=["code'; DROP TABLE nodes; --"])
