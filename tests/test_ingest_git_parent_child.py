...
class TestParentChildChunkingEnabled:
    ...
    def test_create_parent_child_chunks_called_when_enabled(
        ...
        with (
            patch("scripts.ingest.ingest_git.create_parent_child_chunks") as mock_create,
...
class TestParentChildChunkingDisabled:
    ...
    def test_regular_chunks_stored_when_disabled(self, mock_collections, mock_parser, sample_code):
...
class TestParentChildErrorHandling:
    ...
    def test_audit_trail_for_child_storage_failure(
        ...
        with (
            ...
            audit_calls = [
                c for c in mock_audit.call_args_list if c[0][0] == "child_chunks_storage_failed"
            ]
...
class TestParentChildIntegration:
    ...
    def test_empty_chunks_avoid_storage(self, mock_config, mock_collections, mock_parser):
