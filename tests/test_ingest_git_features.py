...
class TestSanitiseArgsForLogging:
    ...
    def test_sanitises_password(self):
        ...
        args = argparse.Namespace(password="secretpassword123", host="https://example.com")
    ...
    def test_sanitises_token(self):
        ...
        args = argparse.Namespace(
            token="ghp_1234567890abcdefghijklmnopqrst", host="https://api.github.com"
        )
        result = sanitise_args_for_logging(args)
    ...
    def test_sanitises_api_username(self):
        ...
        args = argparse.Namespace(api_username="user@example.com", username="myusername")
        result = sanitise_args_for_logging(args)
    ...
    def test_preserves_safe_fields(self):
        ...
        args = argparse.Namespace(
            password="secret", host="https://bitbucket.org", provider="bitbucket", project="MYPROJ"
        )
        result = sanitise_args_for_logging(args)
    ...
    def test_handles_none_values(self):
        ...
        args = argparse.Namespace(
            password=None, token=None, api_username=None, host="https://example.com"
        )
        result = sanitise_args_for_logging(args)
...
class TestGenerateCodeSummary:
    ...
    def test_extracts_key_topics(self):
        ...
        result = generate_code_summary(
            parse_result=parse_result, file_path="api.py", language="python"
        )
    ...
    def test_calculates_scores(self):
        ...
        result = generate_code_summary(
            parse_result=parse_result, file_path="service.py", language="python"
        )
    ...
    def test_handles_parse_error(self):
        ...
        result = generate_code_summary(
            parse_result=parse_result, file_path="file.py", language="python"
        )
...
class TestPhase1Integration:
    ...
    def test_summary_generation_with_various_languages(self):
        ...
        for lang in languages:
            ...
            result = generate_code_summary(
                parse_result=parse_result, file_path=f"service.{lang}", language=lang
            )
