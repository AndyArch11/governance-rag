...
echo "   or:"
echo -e "   ${BLUE}python3 scripts/ingest/ingest.py${NC}"
echo ""
echo "5. Build the consistency graph:"
echo -e "   ${BLUE}make graph${NC}"
echo "   or:"
echo -e "   ${BLUE}python3 scripts/consistency_graph/build_consistency_graph.py${NC}"
echo ""
echo "6. Launch the dashboard:"
echo -e "   ${BLUE}make dashboard${NC}"
echo "   or:"
echo -e "   ${BLUE}python3 scripts/ui/dashboard.py${NC}"
echo ""
